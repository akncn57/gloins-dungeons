...
namespace Enemies
{
    public class EnemyStatsSO : ScriptableObject
    {
        ...
        [field: SerializeField] public float LightAttackKnockbackForce { get; private set; } = 3f;
        [field: SerializeField] public float HeavyAttackKnockbackForce { get; private set; } = 10f;
