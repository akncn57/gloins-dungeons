...
public class TweenData
{
    ...
    [HideIf(nameof(IsTransformAutoSet))]
    public Transform objectToTween;
    public TweenType tweenType;
    [ShowIf("@this.tweenType == TweenType.Move")]
    public MoveType moveType;
    [ShowIf("@(this.tweenType == TweenType.Move || this.tweenType == TweenType.Rotate || this.tweenType == TweenType.Scale || this.tweenType == TweenType.Jump) && moveType != MoveType.Target")]
    public Vector3 targetVector;
    [ShowIf("@(this.tweenType == TweenType.Move || this.tweenType == TweenType.Rotate || this.tweenType == TweenType.Scale || this.tweenType == TweenType.Jump) && moveType == MoveType.Target")]
    public RectTransform targetTransform;
    [ShowIf("tweenType", TweenType.Jump)]
    public Vector2 jumpPowerRange;
    [ShowIf("@this.tweenType == TweenType.Color || this.tweenType == TweenType.Fade")]
    public VisualType targetVisual;

    [ShowIf("tweenType", TweenType.Color)]
    public Color targetColor;
    [ShowIf("@this.tweenType == TweenType.Fade")]
    public float alpha;
    [SerializeField] bool useCurve;
    [ShowIf("@this.useCurve == false")]
    public Ease ease;
    [ShowIf("@this.useCurve == true")]
